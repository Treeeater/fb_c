...
function actionNumber_Dev_Guide_State(int) : int;
...
function type_Knowledge(int) : int;
...
function value_Knowledge(int) : int;
...
implementation Bob_calls()
{
  ...
  var condVal: int;
  var $API_id$2$389.16$Bob_calls: int;
  var $callee_id$1$389.5$Bob_calls: int;
  var $result.not_violating_client_dev_guide$392.35$3$Bob_calls: int;
  var $result.not_violating_common_sense$392.93$4$Bob_calls: int;
  var $result.poirot_nondet$390.24$1$Bob_calls: int;
  var $result.poirot_nondet$391.21$2$Bob_calls: int;
  var tempBoogie0: int;
  var tempBoogie1: int;
  var tempBoogie2: int;
  var tempBoogie3: int;
  ...
  label_5:
    call {:si_unique_call 0} $result.poirot_nondet$390.24$1$Bob_calls := poirot_nondet();
    goto label_8;

  label_8:
    $callee_id$1$389.5$Bob_calls := $result.poirot_nondet$390.24$1$Bob_calls;
    goto label_9;

  label_9:
    call {:si_unique_call 1} $result.poirot_nondet$391.21$2$Bob_calls := poirot_nondet();
    goto label_12;

  label_12:
    $API_id$2$389.16$Bob_calls := $result.poirot_nondet$391.21$2$Bob_calls;
    goto label_13;

  label_13:
    call {:si_unique_call 2} $result.not_violating_client_dev_guide$392.35$3$Bob_calls := not_violating_client_dev_guide(2, $callee_id$1$389.5$Bob_calls, $API_id$2$389.16$Bob_calls);
    goto label_16;
  ...
  label_16_true:
    assume $result.not_violating_client_dev_guide$392.35$3$Bob_calls != 0;
    goto label_17;
  ...
  label_17:
    call {:si_unique_call 3} $result.not_violating_common_sense$392.93$4$Bob_calls := not_violating_common_sense(2, $callee_id$1$389.5$Bob_calls, $API_id$2$389.16$Bob_calls);
    goto label_20;
  ...
  label_20_true:
    assume $result.not_violating_common_sense$392.93$4$Bob_calls != 0;
    goto label_21;
  ...
  label_21:
    call {:si_unique_call 4} update_dev_guide_status(2, $callee_id$1$389.5$Bob_calls, $API_id$2$389.16$Bob_calls);
    goto label_24;
  ...
  label_24_case_0:
    assume INT_NEQ($callee_id$1$389.5$Bob_calls, 7);
    goto label_25;

  label_24_case_1:
    assume INT_EQ($callee_id$1$389.5$Bob_calls, 7);
    goto label_28;

  label_25:
    call {:si_unique_call 5} call_an_API_on_foo_service_app_From_Bob($API_id$2$389.16$Bob_calls);
    goto label_1;

  label_28:
    call {:si_unique_call 6} call_an_API_on_IdP_From_Bob($API_id$2$389.16$Bob_calls);
    goto label_1;
}
...
procedure Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync($redirect_domain$1$9.99$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync_.1: int, $scope$2$9.122$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync_.1: int, $user$3$9.134$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync_.1: int);
  modifies alloc, Mem_T.INT4, Mem_T.Location_Knowledge, Mem_T.cookie_WWAHost_State, temp, Mem_T.access_token_App_Client_State, Mem_T.code_App_Client_State, Mem_T.type_Knowledge, Mem_T.value_Knowledge, Mem_T.token_value_Access_Token, Mem_T.code_value_Code, Mem_T.user_ID_Code, Mem_T.app_secret_Code, Mem_T.app_ID_Code, Mem_T.code_length_FB_Server_State, Mem_T.user_ID_Access_Token, Mem_T.scope_Access_Token, Mem_T.token_length_FB_Server_State, Mem_T.app_ID_Registered_App, Mem_T.app_secret_Registered_App, Mem_T.redirect_domain_Registered_App, Mem_T.scope_Registered_App, Mem_T.scope_length_Registered_App, Mem_T.cookie_value_Cookie, Mem_T.user_ID_Cookie, Mem_T.cookie_length_FB_Server_State, Mem_T.Scope, knowledge_length;
...
implementation Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync($redirect_domain$1$9.99$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync_.1: int, $scope$2$9.122$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync_.1: int, $user$3$9.134$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync_.1: int)
{
  ...
  start:
    call {:si_unique_call 7} $access_token$6$13.5$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync := __HAVOC_malloc(4);
    call {:si_unique_call 8} $code$7$14.5$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync := __HAVOC_malloc(4);
    call {:si_unique_call 9} $cookie$8$15.5$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync := __HAVOC_malloc(4);
    call {:si_unique_call 10} $k$4$11.11$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync := __HAVOC_malloc(8);
    call {:si_unique_call 11} $location$9$16.20$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync := __HAVOC_malloc(4);
  ...
  label_1:
    call {:si_unique_call 12} __HAVOC_free($access_token$6$13.5$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync);
    call {:si_unique_call 13} __HAVOC_free($code$7$14.5$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync);
    call {:si_unique_call 14} __HAVOC_free($cookie$8$15.5$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync);
    call {:si_unique_call 15} __HAVOC_free($k$4$11.11$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync);
    call {:si_unique_call 16} __HAVOC_free($location$9$16.20$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync);
    return;
  ...
  label_7:
    Mem_T.INT4 := Mem_T.INT4[$access_token$6$13.5$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync := 0 - 1];
    goto label_8;
  ...
  label_9:
    Mem_T.INT4 := Mem_T.INT4[$code$7$14.5$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync := 0 - 1];
    goto label_10;
  ...
  label_11:
    Mem_T.INT4 := Mem_T.INT4[$cookie$8$15.5$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync := 0 - 1];
    goto label_12;
  ...
  label_44_true:
    assume INT_NEQ(Mem_T.INT4[$access_token$6$13.5$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync], 0 - 1);
    goto label_45;
  ...
  label_47:
    call {:si_unique_call 20} add_knowledge_to_bob($k$4$11.11$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync);
    goto label_1;
  ...
  label_51_true:
    assume INT_NEQ(Mem_T.INT4[$code$7$14.5$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync], 0 - 1);
    goto label_52;
  ...
  label_54:
    call {:si_unique_call 21} add_knowledge_to_bob($k$4$11.11$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync);
    goto label_1;
  ...
  label_61:
    call {:si_unique_call 22} add_knowledge_to_bob($k$4$11.11$Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync);
    goto label_1;
...
procedure _vswprintf_l($_String$1$73.53.$$static$_vswprintf_l_.1: int, $_Count$2$73.69.$$static$_vswprintf_l_.1: int, $_Format$3$73.93.$$static$_vswprintf_l_.1: int, $_Plocinfo$4$73.112.$$static$_vswprintf_l_.1: int, $_Ap$5$73.131.$$static$_vswprintf_l_.1: int) returns ($result._vswprintf_l$73.30$1.$$static$_vswprintf_l: int);
  modifies Res_KERNEL_SOURCE, Res_PROBED, Mem_T.A0Knowledge, Mem_T.A100Access_Token, Mem_T.A100Code, Mem_T.A100Cookie, Mem_T.A100RP_Session, Mem_T.A100Scope, Mem_T.A37CHAR, Mem_T.A58CHAR, Mem_T.App_ID, Mem_T.App_Owner, Mem_T.App_Secret, Mem_T.Caller, Mem_T.INT4, Mem_T.Knowledge_Type, Mem_T.Location_Knowledge, Mem_T.PAccess_Token, Mem_T.PApp_Client_State, Mem_T.PCHAR, Mem_T.PCode, Mem_T.PCookie, Mem_T.PINT4, Mem_T.PKnowledge, Mem_T.PLocation_Knowledge, Mem_T.PPUINT2, Mem_T.PPlocaleinfo_struct, Mem_T.PRP_Session, Mem_T.PScope, Mem_T.PUINT2, Mem_T.PUser, Mem_T.PUser_Email, Mem_T.Plocaleinfo_struct, Mem_T.Redirect_Domain, Mem_T.Response_Type, Mem_T.Scope, Mem_T.UINT4, Mem_T.User, Mem_T.User_Credentials, Mem_T.User_Email, Mem_T.access_token_App_Client_State, Mem_T.actionNumber_Dev_Guide_State, Mem_T.app_ID_App_Client_State, Mem_T.app_ID_Code, Mem_T.app_ID_Registered_App, Mem_T.app_length_FB_Server_State, Mem_T.app_owner_App_Client_State, Mem_T.app_secret_Code, Mem_T.app_secret_Registered_App, Mem_T.code_App_Client_State, Mem_T.code_length_FB_Server_State, Mem_T.code_value_Code, Mem_T.codes_FB_Server_State, Mem_T.cookie_WWAHost_State, Mem_T.cookie_length_FB_Server_State, Mem_T.cookie_value_Cookie, Mem_T.cookies_FB_Server_State, Mem_T.current_state_WWAHost_State, Mem_T.redirect_domain_Registered_App, Mem_T.rp_sessions_RP_State, Mem_T.scope_Access_Token, Mem_T.scope_Registered_App, Mem_T.scope_length_Registered_App, Mem_T.session_ID_RP_Session, Mem_T.session_length_RP_State, Mem_T.token_length_FB_Server_State, Mem_T.token_value_Access_Token, Mem_T.tokens_FB_Server_State, Mem_T.type_Knowledge, Mem_T.user_ID_Access_Token, Mem_T.user_ID_Code, Mem_T.user_ID_Cookie, Mem_T.user_ID_RP_Session, Mem_T.value_Knowledge, devGuideState, foo_rp_state, knowledge_length, server_state, temp, wwahost_state;



procedure add_knowledge_to_bob($k$1$20.36$add_knowledge_to_bob_.1: int);
  modifies alloc, Mem_T.value_Knowledge, Mem_T.type_Knowledge, knowledge_length;



implementation add_knowledge_to_bob($k$1$20.36$add_knowledge_to_bob_.1: int)
{
  var havoc_stringTemp: int;
  var condVal: int;
  ...
  start:
    call {:si_unique_call 23} $k$1$20.36$add_knowledge_to_bob := __HAVOC_malloc(8);
  ...
  label_1:
    call {:si_unique_call 24} __HAVOC_free($k$1$20.36$add_knowledge_to_bob);
    return;
...
implementation authenticate_user($access_token$1$8.33$authenticate_user_.1: int) returns ($result.authenticate_user$8.11$1$authenticate_user: int)
{
  ...
  start:
    call {:si_unique_call 25} $rps$2$10.12$authenticate_user := __HAVOC_malloc(8);
    call {:si_unique_call 26} $user_ID$3$11.6$authenticate_user := __HAVOC_malloc(4);
    $access_token$1$8.33$authenticate_user := $access_token$1$8.33$authenticate_user_.1;
    goto label_3;

  label_1:
    call {:si_unique_call 27} __HAVOC_free($rps$2$10.12$authenticate_user);
    call {:si_unique_call 28} __HAVOC_free($user_ID$3$11.6$authenticate_user);
    return;
  ...
  label_6:
    Mem_T.session_ID_RP_Session := Mem_T.session_ID_RP_Session[session_ID_RP_Session($rps$2$10.12$authenticate_user) := 0 - 1];
    goto label_7;
  ...
  label_8:
    call {:si_unique_call 29} $result.graph_facebook_com_me$14.26$2$authenticate_user := graph_facebook_com_me($access_token$1$8.33$authenticate_user, $user_ID$3$11.6$authenticate_user);
    goto label_11;
...
procedure call_an_API_on_IdP_From_Bob($API_id$1$138.37$call_an_API_on_IdP_From_Bob_.1: int);
  modifies alloc, Mem_T.INT4, Mem_T.Location_Knowledge, temp, Mem_T.type_Knowledge, Mem_T.value_Knowledge, knowledge_length, Mem_T.Scope, Mem_T.token_value_Access_Token, Mem_T.code_value_Code, Mem_T.user_ID_Code, Mem_T.app_secret_Code, Mem_T.app_ID_Code, Mem_T.code_length_FB_Server_State, Mem_T.user_ID_Access_Token, Mem_T.scope_Access_Token, Mem_T.token_length_FB_Server_State, Mem_T.app_ID_Registered_App, Mem_T.app_secret_Registered_App, Mem_T.redirect_domain_Registered_App, Mem_T.scope_Registered_App, Mem_T.scope_length_Registered_App, Mem_T.cookie_value_Cookie, Mem_T.user_ID_Cookie, Mem_T.cookie_length_FB_Server_State;



implementation call_an_API_on_IdP_From_Bob($API_id$1$138.37$call_an_API_on_IdP_From_Bob_.1: int)
{
  var havoc_stringTemp: int;
  var condVal: int;
  var $API_id$1$138.37$call_an_API_on_IdP_From_Bob: int;
  var $access_token$2$139.5$call_an_API_on_IdP_From_Bob: int;
  var $app_ID$12$149.8$call_an_API_on_IdP_From_Bob: int;
  var $code$3$140.5$call_an_API_on_IdP_From_Bob: int;
  var $cookie$4$141.5$call_an_API_on_IdP_From_Bob: int;
  var $k$6$143.11$call_an_API_on_IdP_From_Bob: int;
  var $location$8$145.20$call_an_API_on_IdP_From_Bob: int;
  var $redirect_domain$9$146.17$call_an_API_on_IdP_From_Bob: int;
  var $response_type$11$148.15$call_an_API_on_IdP_From_Bob: int;
  var $result.dialog_oauth$159.29$5$call_an_API_on_IdP_From_Bob: int;
  var $result.dialog_permissions_request$192.43$13$call_an_API_on_IdP_From_Bob: int;
  var $result.draw_from_knowledge_pool$159.54$6$call_an_API_on_IdP_From_Bob: int;
  var $result.draw_from_knowledge_pool$178.77$9$call_an_API_on_IdP_From_Bob: int;
  var $result.draw_from_knowledge_pool$192.76$14$call_an_API_on_IdP_From_Bob: int;
  var $result.login_php$178.26$8$call_an_API_on_IdP_From_Bob: int;
  var $result.poirot_nondet$152.34$1$call_an_API_on_IdP_From_Bob: int;
  var $result.poirot_nondet$153.24$2$call_an_API_on_IdP_From_Bob: int;
  var $result.poirot_nondet$155.23$3$call_an_API_on_IdP_From_Bob: int;
  var $result.poirot_nondet$157.32$4$call_an_API_on_IdP_From_Bob: int;
  var $result.poirot_nondet$176.23$7$call_an_API_on_IdP_From_Bob: int;
  var $result.poirot_nondet$186.24$10$call_an_API_on_IdP_From_Bob: int;
  var $result.poirot_nondet$188.32$11$call_an_API_on_IdP_From_Bob: int;
  var $result.poirot_nondet$190.25$12$call_an_API_on_IdP_From_Bob: int;
  var $returnValue$5$142.5$call_an_API_on_IdP_From_Bob: int;
  var $scope$10$147.7$call_an_API_on_IdP_From_Bob: int;
  var $user$7$144.6$call_an_API_on_IdP_From_Bob: int;
  var tempBoogie0: int;
  var tempBoogie1: int;
  var tempBoogie2: int;
  var tempBoogie3: int;
  ...
  start:
    call {:si_unique_call 30} $access_token$2$139.5$call_an_API_on_IdP_From_Bob := __HAVOC_malloc(4);
    call {:si_unique_call 31} $code$3$140.5$call_an_API_on_IdP_From_Bob := __HAVOC_malloc(4);
    call {:si_unique_call 32} $cookie$4$141.5$call_an_API_on_IdP_From_Bob := __HAVOC_malloc(4);
    call {:si_unique_call 33} $k$6$143.11$call_an_API_on_IdP_From_Bob := __HAVOC_malloc(8);
    call {:si_unique_call 34} $location$8$145.20$call_an_API_on_IdP_From_Bob := __HAVOC_malloc(4);
    $API_id$1$138.37$call_an_API_on_IdP_From_Bob := $API_id$1$138.37$call_an_API_on_IdP_From_Bob_.1;
    goto label_3;

  label_1:
    call {:si_unique_call 35} __HAVOC_free($access_token$2$139.5$call_an_API_on_IdP_From_Bob);
    call {:si_unique_call 36} __HAVOC_free($code$3$140.5$call_an_API_on_IdP_From_Bob);
    call {:si_unique_call 37} __HAVOC_free($cookie$4$141.5$call_an_API_on_IdP_From_Bob);
    call {:si_unique_call 38} __HAVOC_free($k$6$143.11$call_an_API_on_IdP_From_Bob);
    call {:si_unique_call 39} __HAVOC_free($location$8$145.20$call_an_API_on_IdP_From_Bob);
    return;
  ...
  label_4:
    Mem_T.INT4 := Mem_T.INT4[$access_token$2$139.5$call_an_API_on_IdP_From_Bob := 0 - 1];
    goto label_5;
  ...
  label_6:
    Mem_T.INT4 := Mem_T.INT4[$code$3$140.5$call_an_API_on_IdP_From_Bob := 0 - 1];
    goto label_7;
  ...
  label_8:
    Mem_T.INT4 := Mem_T.INT4[$cookie$4$141.5$call_an_API_on_IdP_From_Bob := 0 - 1];
    goto label_9;
  ...
  label_10:
    $returnValue$5$142.5$call_an_API_on_IdP_From_Bob := 400;
    goto label_11;
  ...
  label_13:
    $user$7$144.6$call_an_API_on_IdP_From_Bob := 0;
    goto label_14;
  ...
  label_15:
    Mem_T.Location_Knowledge := Mem_T.Location_Knowledge[$location$8$145.20$call_an_API_on_IdP_From_Bob := 0];
    goto label_16;
  ...
  label_17:
    $redirect_domain$9$146.17$call_an_API_on_IdP_From_Bob := 0;
    goto label_18;
  ...
  label_19:
    $scope$10$147.7$call_an_API_on_IdP_From_Bob := 0;
    goto label_20;
  ...
  label_21:
    $response_type$11$148.15$call_an_API_on_IdP_From_Bob := 0;
    goto label_22;
  ...
  label_23_case_0:
    assume INT_NEQ($API_id$1$138.37$call_an_API_on_IdP_From_Bob, 1);
    assume INT_NEQ($API_id$1$138.37$call_an_API_on_IdP_From_Bob, 2);
    assume INT_NEQ($API_id$1$138.37$call_an_API_on_IdP_From_Bob, 3);
    goto label_1;

  label_23_case_1:
    assume INT_EQ($API_id$1$138.37$call_an_API_on_IdP_From_Bob, 1);
    goto label_24;

  label_23_case_2:
    assume INT_EQ($API_id$1$138.37$call_an_API_on_IdP_From_Bob, 2);
    goto label_27;

  label_23_case_3:
    assume INT_EQ($API_id$1$138.37$call_an_API_on_IdP_From_Bob, 3);
    goto label_30;

  label_24:
    call {:si_unique_call 40} $result.poirot_nondet$152.34$1$call_an_API_on_IdP_From_Bob := poirot_nondet();
    goto label_81;

  label_27:
    call {:si_unique_call 41} $result.poirot_nondet$176.23$7$call_an_API_on_IdP_From_Bob := poirot_nondet();
    goto label_66;
  ...
  label_31:
    call {:si_unique_call 42} $result.poirot_nondet$186.24$10$call_an_API_on_IdP_From_Bob := poirot_nondet();
    goto label_34;

  label_34:
    $scope$10$147.7$call_an_API_on_IdP_From_Bob := $result.poirot_nondet$186.24$10$call_an_API_on_IdP_From_Bob;
    goto label_35;

  label_35:
    assume INT_EQ($scope$10$147.7$call_an_API_on_IdP_From_Bob, 1) || INT_EQ($scope$10$147.7$call_an_API_on_IdP_From_Bob, 2);
    goto label_36;

  label_36:
    call {:si_unique_call 43} $result.poirot_nondet$188.32$11$call_an_API_on_IdP_From_Bob := poirot_nondet();
    goto label_39;

  label_39:
    $response_type$11$148.15$call_an_API_on_IdP_From_Bob := $result.poirot_nondet$188.32$11$call_an_API_on_IdP_From_Bob;
    goto label_40;

  label_40:
    assume INT_EQ($response_type$11$148.15$call_an_API_on_IdP_From_Bob, 0) || INT_EQ($user$7$144.6$call_an_API_on_IdP_From_Bob, 1);
    goto label_41;

  label_41:
    call {:si_unique_call 44} $result.poirot_nondet$190.25$12$call_an_API_on_IdP_From_Bob := poirot_nondet();
    goto label_44;

  label_44:
    $app_ID$12$149.8$call_an_API_on_IdP_From_Bob := $result.poirot_nondet$190.25$12$call_an_API_on_IdP_From_Bob;
    goto label_45;

  label_45:
    assume INT_EQ($app_ID$12$149.8$call_an_API_on_IdP_From_Bob, 0) || INT_EQ($app_ID$12$149.8$call_an_API_on_IdP_From_Bob, 1);
    goto label_46;

  label_46:
    call {:si_unique_call 45} $result.draw_from_knowledge_pool$192.76$14$call_an_API_on_IdP_From_Bob := draw_from_knowledge_pool(2);
    goto label_49;

  label_49:
    call {:si_unique_call 46} $result.dialog_permissions_request$192.43$13$call_an_API_on_IdP_From_Bob := dialog_permissions_request($app_ID$12$149.8$call_an_API_on_IdP_From_Bob, $result.draw_from_knowledge_pool$192.76$14$call_an_API_on_IdP_From_Bob, $scope$10$147.7$call_an_API_on_IdP_From_Bob, $response_type$11$148.15$call_an_API_on_IdP_From_Bob, $location$8$145.20$call_an_API_on_IdP_From_Bob, $access_token$2$139.5$call_an_API_on_IdP_From_Bob, $code$3$140.5$call_an_API_on_IdP_From_Bob);
    goto label_52;

  label_52:
    $returnValue$5$142.5$call_an_API_on_IdP_From_Bob := $result.dialog_permissions_request$192.43$13$call_an_API_on_IdP_From_Bob;
    goto label_53;
  ...
  label_53_true:
    assume INT_EQ($returnValue$5$142.5$call_an_API_on_IdP_From_Bob, 400);
    goto label_1;
  ...
  label_54_true:
    assume INT_NEQ(Mem_T.INT4[$access_token$2$139.5$call_an_API_on_IdP_From_Bob], 0 - 1);
    goto label_56;
  ...
  label_55_true:
    assume INT_NEQ(Mem_T.INT4[$code$3$140.5$call_an_API_on_IdP_From_Bob], 0 - 1);
    goto label_61;
  ...
  label_56:
    Mem_T.type_Knowledge := Mem_T.type_Knowledge[type_Knowledge($k$6$143.11$call_an_API_on_IdP_From_Bob) := 1];
    goto label_57;

  label_57:
    Mem_T.value_Knowledge := Mem_T.value_Knowledge[value_Knowledge($k$6$143.11$call_an_API_on_IdP_From_Bob) := Mem_T.INT4[$access_token$2$139.5$call_an_API_on_IdP_From_Bob]];
    goto label_58;

  label_58:
    call {:si_unique_call 47} add_knowledge_to_bob($k$6$143.11$call_an_API_on_IdP_From_Bob);
    goto label_55;

  label_61:
    Mem_T.type_Knowledge := Mem_T.type_Knowledge[type_Knowledge($k$6$143.11$call_an_API_on_IdP_From_Bob) := 3];
    goto label_62;

  label_62:
    Mem_T.value_Knowledge := Mem_T.value_Knowledge[value_Knowledge($k$6$143.11$call_an_API_on_IdP_From_Bob) := Mem_T.INT4[$code$3$140.5$call_an_API_on_IdP_From_Bob]];
    goto label_63;

  label_63:
    call {:si_unique_call 48} add_knowledge_to_bob($k$6$143.11$call_an_API_on_IdP_From_Bob);
    goto label_1;

  label_66:
    $user$7$144.6$call_an_API_on_IdP_From_Bob := $result.poirot_nondet$176.23$7$call_an_API_on_IdP_From_Bob;
    goto label_67;

  label_67:
    assume INT_EQ($user$7$144.6$call_an_API_on_IdP_From_Bob, 1) || INT_EQ($user$7$144.6$call_an_API_on_IdP_From_Bob, 2);
    goto label_68;

  label_68:
    call {:si_unique_call 49} $result.draw_from_knowledge_pool$178.77$9$call_an_API_on_IdP_From_Bob := draw_from_knowledge_pool(8);
    goto label_71;

  label_71:
    call {:si_unique_call 50} $result.login_php$178.26$8$call_an_API_on_IdP_From_Bob := login_php($user$7$144.6$call_an_API_on_IdP_From_Bob, $location$8$145.20$call_an_API_on_IdP_From_Bob, $cookie$4$141.5$call_an_API_on_IdP_From_Bob, $result.draw_from_knowledge_pool$178.77$9$call_an_API_on_IdP_From_Bob);
    goto label_74;

  label_74:
    $returnValue$5$142.5$call_an_API_on_IdP_From_Bob := $result.login_php$178.26$8$call_an_API_on_IdP_From_Bob;
    goto label_75;
  ...
  label_76:
    Mem_T.type_Knowledge := Mem_T.type_Knowledge[type_Knowledge($k$6$143.11$call_an_API_on_IdP_From_Bob) := 2];
    goto label_77;

  label_77:
    Mem_T.value_Knowledge := Mem_T.value_Knowledge[value_Knowledge($k$6$143.11$call_an_API_on_IdP_From_Bob) := Mem_T.INT4[$cookie$4$141.5$call_an_API_on_IdP_From_Bob]];
    goto label_78;

  label_78:
    call {:si_unique_call 51} add_knowledge_to_bob($k$6$143.11$call_an_API_on_IdP_From_Bob);
    goto label_1;

  label_81:
    $redirect_domain$9$146.17$call_an_API_on_IdP_From_Bob := $result.poirot_nondet$152.34$1$call_an_API_on_IdP_From_Bob;
    goto label_82;

  label_82:
    call {:si_unique_call 52} $result.poirot_nondet$153.24$2$call_an_API_on_IdP_From_Bob := poirot_nondet();
    goto label_85;

  label_85:
    $scope$10$147.7$call_an_API_on_IdP_From_Bob := $result.poirot_nondet$153.24$2$call_an_API_on_IdP_From_Bob;
    goto label_86;
  ...
  label_87:
    call {:si_unique_call 53} $result.poirot_nondet$155.23$3$call_an_API_on_IdP_From_Bob := poirot_nondet();
    goto label_90;

  label_90:
    $user$7$144.6$call_an_API_on_IdP_From_Bob := $result.poirot_nondet$155.23$3$call_an_API_on_IdP_From_Bob;
    goto label_91;
  ...
  label_92:
    call {:si_unique_call 54} $result.poirot_nondet$157.32$4$call_an_API_on_IdP_From_Bob := poirot_nondet();
    goto label_95;

  label_95:
    $response_type$11$148.15$call_an_API_on_IdP_From_Bob := $result.poirot_nondet$157.32$4$call_an_API_on_IdP_From_Bob;
    goto label_96;
  ...
  label_97:
    call {:si_unique_call 55} $result.draw_from_knowledge_pool$159.54$6$call_an_API_on_IdP_From_Bob := draw_from_knowledge_pool(2);
    goto label_100;

  label_100:
    call {:si_unique_call 56} $result.dialog_oauth$159.29$5$call_an_API_on_IdP_From_Bob := dialog_oauth($result.draw_from_knowledge_pool$159.54$6$call_an_API_on_IdP_From_Bob, Mem_T.app_ID_App_Client_State[app_ID_App_Client_State(Mem_T.current_state_WWAHost_State[current_state_WWAHost_State(wwahost_state)])], $redirect_domain$9$146.17$call_an_API_on_IdP_From_Bob, $scope$10$147.7$call_an_API_on_IdP_From_Bob, $user$7$144.6$call_an_API_on_IdP_From_Bob, $response_type$11$148.15$call_an_API_on_IdP_From_Bob, $location$8$145.20$call_an_API_on_IdP_From_Bob, $access_token$2$139.5$call_an_API_on_IdP_From_Bob, $code$3$140.5$call_an_API_on_IdP_From_Bob);
    goto label_103;

  label_103:
    $returnValue$5$142.5$call_an_API_on_IdP_From_Bob := $result.dialog_oauth$159.29$5$call_an_API_on_IdP_From_Bob;
    goto label_104;
  ...
  label_109:
    call {:si_unique_call 57} add_knowledge_to_bob($k$6$143.11$call_an_API_on_IdP_From_Bob);
    goto label_106;
  ...
  label_114:
    call {:si_unique_call 58} add_knowledge_to_bob($k$6$143.11$call_an_API_on_IdP_From_Bob);
    goto label_1;
}



procedure call_an_API_on_IdP_From_Client($API_id$1$257.40$call_an_API_on_IdP_From_Client_.1: int);
  modifies alloc, Mem_T.INT4, Mem_T.User, Mem_T.Location_Knowledge, temp, Mem_T.type_Knowledge, Mem_T.value_Knowledge, knowledge_length, Mem_T.cookie_WWAHost_State, Mem_T.User_Email, Mem_T.Scope, Mem_T.token_value_Access_Token, Mem_T.code_value_Code, Mem_T.user_ID_Code, Mem_T.app_secret_Code, Mem_T.app_ID_Code, Mem_T.code_length_FB_Server_State, Mem_T.user_ID_Access_Token, Mem_T.scope_Access_Token, Mem_T.token_length_FB_Server_State, Mem_T.app_ID_Registered_App, Mem_T.app_secret_Registered_App, Mem_T.redirect_domain_Registered_App, Mem_T.scope_Registered_App, Mem_T.scope_length_Registered_App, Mem_T.cookie_value_Cookie, Mem_T.user_ID_Cookie, Mem_T.cookie_length_FB_Server_State;



implementation call_an_API_on_IdP_From_Client($API_id$1$257.40$call_an_API_on_IdP_From_Client_.1: int)
{
  var havoc_stringTemp: int;
  var condVal: int;
  var $API_id$1$257.40$call_an_API_on_IdP_From_Client: int;
  var $access_token$2$259.5$call_an_API_on_IdP_From_Client: int;
  var $app_ID$8$265.8$call_an_API_on_IdP_From_Client: int;
  var $code$4$261.5$call_an_API_on_IdP_From_Client: int;
  var $cookie$5$262.5$call_an_API_on_IdP_From_Client: int;
  var $k$7$264.11$call_an_API_on_IdP_From_Client: int;
  var $location$10$267.20$call_an_API_on_IdP_From_Client: int;
  var $redirect_domain$11$268.17$call_an_API_on_IdP_From_Client: int;
  var $response_type$13$270.15$call_an_API_on_IdP_From_Client: int;
  var $result.dialog_oauth$282.29$6$call_an_API_on_IdP_From_Client: int;
  var $result.dialog_permissions_request$315.43$13$call_an_API_on_IdP_From_Client: int;
  var $result.draw_from_knowledge_pool$282.54$7$call_an_API_on_IdP_From_Client: int;
  var $result.draw_from_knowledge_pool$315.77$14$call_an_API_on_IdP_From_Client: int;
  var $result.draw_from_knowledge_pool$335.67$16$call_an_API_on_IdP_From_Client: int;
  var $result.draw_from_knowledge_pool$338.70$18$call_an_API_on_IdP_From_Client: int;
  var $result.draw_from_knowledge_pool$344.108$23$call_an_API_on_IdP_From_Client: int;
  var $result.draw_from_knowledge_pool$344.149$22$call_an_API_on_IdP_From_Client: int;
  var $result.graph_facebook_com_email_bob$338.45$17$call_an_API_on_IdP_From_Client: int;
  var $result.graph_facebook_com_me_bob$335.42$15$call_an_API_on_IdP_From_Client: int;
  var $result.graph_facebook_com_oauth_access_token_bob$344.58$21$call_an_API_on_IdP_From_Client: int;
  var $result.login_php$303.26$9$call_an_API_on_IdP_From_Client: int;
  var $result.poirot_nondet$273.34$1$call_an_API_on_IdP_From_Client: int;
  var $result.poirot_nondet$274.24$2$call_an_API_on_IdP_From_Client: int;
  var $result.poirot_nondet$276.23$3$call_an_API_on_IdP_From_Client: int;
  var $result.poirot_nondet$278.32$4$call_an_API_on_IdP_From_Client: int;
  var $result.poirot_nondet$280.25$5$call_an_API_on_IdP_From_Client: int;
  var $result.poirot_nondet$301.23$8$call_an_API_on_IdP_From_Client: int;
  var $result.poirot_nondet$309.24$10$call_an_API_on_IdP_From_Client: int;
  var $result.poirot_nondet$311.32$11$call_an_API_on_IdP_From_Client: int;
  var $result.poirot_nondet$313.25$12$call_an_API_on_IdP_From_Client: int;
  var $result.poirot_nondet$341.34$19$call_an_API_on_IdP_From_Client: int;
  var $result.poirot_nondet$342.25$20$call_an_API_on_IdP_From_Client: int;
  var $returnValue$6$263.5$call_an_API_on_IdP_From_Client: int;
  var $scope$12$269.7$call_an_API_on_IdP_From_Client: int;
  var $user$9$266.6$call_an_API_on_IdP_From_Client: int;
  var $user_email$3$260.12$call_an_API_on_IdP_From_Client: int;
  var tempBoogie0: int;
  var tempBoogie1: int;
  var tempBoogie2: int;
  var tempBoogie3: int;
  ...
  start:
    call {:si_unique_call 59} $access_token$2$259.5$call_an_API_on_IdP_From_Client := __HAVOC_malloc(4);
    call {:si_unique_call 60} $code$4$261.5$call_an_API_on_IdP_From_Client := __HAVOC_malloc(4);
    call {:si_unique_call 61} $cookie$5$262.5$call_an_API_on_IdP_From_Client := __HAVOC_malloc(4);
    call {:si_unique_call 62} $k$7$264.11$call_an_API_on_IdP_From_Client := __HAVOC_malloc(8);
    call {:si_unique_call 63} $location$10$267.20$call_an_API_on_IdP_From_Client := __HAVOC_malloc(4);
    call {:si_unique_call 64} $user$9$266.6$call_an_API_on_IdP_From_Client := __HAVOC_malloc(4);
    call {:si_unique_call 65} $user_email$3$260.12$call_an_API_on_IdP_From_Client := __HAVOC_malloc(4);
    $API_id$1$257.40$call_an_API_on_IdP_From_Client := $API_id$1$257.40$call_an_API_on_IdP_From_Client_.1;
    goto label_3;

  label_1:
    call {:si_unique_call 66} __HAVOC_free($access_token$2$259.5$call_an_API_on_IdP_From_Client);
    call {:si_unique_call 67} __HAVOC_free($code$4$261.5$call_an_API_on_IdP_From_Client);
    call {:si_unique_call 68} __HAVOC_free($cookie$5$262.5$call_an_API_on_IdP_From_Client);
    call {:si_unique_call 69} __HAVOC_free($k$7$264.11$call_an_API_on_IdP_From_Client);
    call {:si_unique_call 70} __HAVOC_free($location$10$267.20$call_an_API_on_IdP_From_Client);
    call {:si_unique_call 71} __HAVOC_free($user$9$266.6$call_an_API_on_IdP_From_Client);
    call {:si_unique_call 72} __HAVOC_free($user_email$3$260.12$call_an_API_on_IdP_From_Client);
    return;
  ...
  label_4:
    Mem_T.INT4 := Mem_T.INT4[$access_token$2$259.5$call_an_API_on_IdP_From_Client := 0 - 1];
    goto label_5;
  ...
  label_7:
    Mem_T.INT4 := Mem_T.INT4[$code$4$261.5$call_an_API_on_IdP_From_Client := 0 - 1];
    goto label_8;
  ...
  label_9:
    Mem_T.INT4 := Mem_T.INT4[$cookie$5$262.5$call_an_API_on_IdP_From_Client := 0 - 1];
    goto label_10;
  ...
  label_11:
    $returnValue$6$263.5$call_an_API_on_IdP_From_Client := 400;
    goto label_12;
  ...
  label_15:
    Mem_T.User := Mem_T.User[$user$9$266.6$call_an_API_on_IdP_From_Client := 0];
    goto label_16;
  ...
  label_17:
    Mem_T.Location_Knowledge := Mem_T.Location_Knowledge[$location$10$267.20$call_an_API_on_IdP_From_Client := 0];
    goto label_18;
  ...
  label_19:
    $redirect_domain$11$268.17$call_an_API_on_IdP_From_Client := 0;
    goto label_20;
  ...
  label_21:
    $scope$12$269.7$call_an_API_on_IdP_From_Client := 0;
    goto label_22;
  ...
  label_23:
    $response_type$13$270.15$call_an_API_on_IdP_From_Client := 0;
    goto label_24;
  ...
  label_24_case_0:
    assume INT_NEQ($API_id$1$257.40$call_an_API_on_IdP_From_Client, 1);
    assume INT_NEQ($API_id$1$257.40$call_an_API_on_IdP_From_Client, 2);
    assume INT_NEQ($API_id$1$257.40$call_an_API_on_IdP_From_Client, 3);
    assume INT_NEQ($API_id$1$257.40$call_an_API_on_IdP_From_Client, 4);
    assume INT_NEQ($API_id$1$257.40$call_an_API_on_IdP_From_Client, 5);
    goto label_25;

  label_24_case_1:
    assume INT_EQ($API_id$1$257.40$call_an_API_on_IdP_From_Client, 1);
    goto label_28;

  label_24_case_2:
    assume INT_EQ($API_id$1$257.40$call_an_API_on_IdP_From_Client, 2);
    goto label_31;

  label_24_case_3:
    assume INT_EQ($API_id$1$257.40$call_an_API_on_IdP_From_Client, 3);
    goto label_34;

  label_24_case_4:
    assume INT_EQ($API_id$1$257.40$call_an_API_on_IdP_From_Client, 4);
    goto label_35;

  label_24_case_5:
    assume INT_EQ($API_id$1$257.40$call_an_API_on_IdP_From_Client, 5);
    goto label_38;

  label_25:
    call {:si_unique_call 73} $result.poirot_nondet$341.34$19$call_an_API_on_IdP_From_Client := poirot_nondet();
    goto label_138;

  label_28:
    call {:si_unique_call 74} $result.poirot_nondet$273.34$1$call_an_API_on_IdP_From_Client := poirot_nondet();
    goto label_95;

  label_31:
    call {:si_unique_call 75} $result.poirot_nondet$301.23$8$call_an_API_on_IdP_From_Client := poirot_nondet();
    goto label_86;
  ...
  label_35:
    call {:si_unique_call 76} $result.draw_from_knowledge_pool$335.67$16$call_an_API_on_IdP_From_Client := draw_from_knowledge_pool(1);
    goto label_45;

  label_38:
    call {:si_unique_call 77} $result.draw_from_knowledge_pool$338.70$18$call_an_API_on_IdP_From_Client := draw_from_knowledge_pool(1);
    goto label_41;

  label_41:
    call {:si_unique_call 78} $result.graph_facebook_com_email_bob$338.45$17$call_an_API_on_IdP_From_Client := graph_facebook_com_email_bob($result.draw_from_knowledge_pool$338.70$18$call_an_API_on_IdP_From_Client, $user_email$3$260.12$call_an_API_on_IdP_From_Client);
    goto label_44;

  label_44:
    $returnValue$6$263.5$call_an_API_on_IdP_From_Client := $result.graph_facebook_com_email_bob$338.45$17$call_an_API_on_IdP_From_Client;
    goto label_1;

  label_45:
    call {:si_unique_call 79} $result.graph_facebook_com_me_bob$335.42$15$call_an_API_on_IdP_From_Client := graph_facebook_com_me_bob($result.draw_from_knowledge_pool$335.67$16$call_an_API_on_IdP_From_Client, $user$9$266.6$call_an_API_on_IdP_From_Client);
    goto label_48;

  label_48:
    $returnValue$6$263.5$call_an_API_on_IdP_From_Client := $result.graph_facebook_com_me_bob$335.42$15$call_an_API_on_IdP_From_Client;
    goto label_1;

  label_49:
    call {:si_unique_call 80} $result.poirot_nondet$309.24$10$call_an_API_on_IdP_From_Client := poirot_nondet();
    goto label_52;

  label_52:
    $scope$12$269.7$call_an_API_on_IdP_From_Client := $result.poirot_nondet$309.24$10$call_an_API_on_IdP_From_Client;
    goto label_53;

  label_53:
    assume INT_EQ($scope$12$269.7$call_an_API_on_IdP_From_Client, 1) || INT_EQ($scope$12$269.7$call_an_API_on_IdP_From_Client, 2);
    goto label_54;

  label_54:
    call {:si_unique_call 81} $result.poirot_nondet$311.32$11$call_an_API_on_IdP_From_Client := poirot_nondet();
    goto label_57;

  label_57:
    $response_type$13$270.15$call_an_API_on_IdP_From_Client := $result.poirot_nondet$311.32$11$call_an_API_on_IdP_From_Client;
    goto label_58;

  label_58:
    assume INT_EQ($response_type$13$270.15$call_an_API_on_IdP_From_Client, 0) || INT_EQ(Mem_T.User[$user$9$266.6$call_an_API_on_IdP_From_Client], 1);
    goto label_59;

  label_59:
    call {:si_unique_call 82} $result.poirot_nondet$313.25$12$call_an_API_on_IdP_From_Client := poirot_nondet();
    goto label_62;

  label_62:
    $app_ID$8$265.8$call_an_API_on_IdP_From_Client := $result.poirot_nondet$313.25$12$call_an_API_on_IdP_From_Client;
    goto label_63;

  label_63:
    assume INT_EQ($app_ID$8$265.8$call_an_API_on_IdP_From_Client, 0) || INT_EQ($app_ID$8$265.8$call_an_API_on_IdP_From_Client, 1);
    goto label_64;

  label_64:
    call {:si_unique_call 83} $result.draw_from_knowledge_pool$315.77$14$call_an_API_on_IdP_From_Client := draw_from_knowledge_pool(2);
    goto label_67;

  label_67:
    call {:si_unique_call 84} $result.dialog_permissions_request$315.43$13$call_an_API_on_IdP_From_Client := dialog_permissions_request($app_ID$8$265.8$call_an_API_on_IdP_From_Client, $result.draw_from_knowledge_pool$315.77$14$call_an_API_on_IdP_From_Client, $scope$12$269.7$call_an_API_on_IdP_From_Client, $response_type$13$270.15$call_an_API_on_IdP_From_Client, $location$10$267.20$call_an_API_on_IdP_From_Client, $access_token$2$259.5$call_an_API_on_IdP_From_Client, $code$4$261.5$call_an_API_on_IdP_From_Client);
    goto label_70;

  label_70:
    $returnValue$6$263.5$call_an_API_on_IdP_From_Client := $result.dialog_permissions_request$315.43$13$call_an_API_on_IdP_From_Client;
    goto label_71;
  ...
  label_71_true:
    assume INT_EQ($returnValue$6$263.5$call_an_API_on_IdP_From_Client, 400);
    goto label_1;
  ...
  label_72_true:
    assume INT_EQ($returnValue$6$263.5$call_an_API_on_IdP_From_Client, 302);
    goto label_73;
  ...
  label_73_true:
    assume INT_EQ(Mem_T.Location_Knowledge[$location$10$267.20$call_an_API_on_IdP_From_Client], 3);
    goto label_74;
  ...
  label_74_true:
    assume INT_NEQ(Mem_T.INT4[$access_token$2$259.5$call_an_API_on_IdP_From_Client], 0 - 1);
    goto label_76;
  ...
  label_75_true:
    assume INT_NEQ(Mem_T.INT4[$code$4$261.5$call_an_API_on_IdP_From_Client], 0 - 1);
    goto label_81;
  ...
  label_76:
    Mem_T.type_Knowledge := Mem_T.type_Knowledge[type_Knowledge($k$7$264.11$call_an_API_on_IdP_From_Client) := 1];
    goto label_77;

  label_77:
    Mem_T.value_Knowledge := Mem_T.value_Knowledge[value_Knowledge($k$7$264.11$call_an_API_on_IdP_From_Client) := Mem_T.INT4[$access_token$2$259.5$call_an_API_on_IdP_From_Client]];
    goto label_78;

  label_78:
    call {:si_unique_call 85} add_knowledge_to_bob($k$7$264.11$call_an_API_on_IdP_From_Client);
    goto label_75;

  label_81:
    Mem_T.type_Knowledge := Mem_T.type_Knowledge[type_Knowledge($k$7$264.11$call_an_API_on_IdP_From_Client) := 3];
    goto label_82;

  label_82:
    Mem_T.value_Knowledge := Mem_T.value_Knowledge[value_Knowledge($k$7$264.11$call_an_API_on_IdP_From_Client) := Mem_T.INT4[$code$4$261.5$call_an_API_on_IdP_From_Client]];
    goto label_83;

  label_83:
    call {:si_unique_call 86} add_knowledge_to_bob($k$7$264.11$call_an_API_on_IdP_From_Client);
    goto label_1;

  label_86:
    Mem_T.User := Mem_T.User[$user$9$266.6$call_an_API_on_IdP_From_Client := $result.poirot_nondet$301.23$8$call_an_API_on_IdP_From_Client];
    goto label_87;

  label_87:
    assume INT_EQ(Mem_T.User[$user$9$266.6$call_an_API_on_IdP_From_Client], 1) || INT_EQ(Mem_T.User[$user$9$266.6$call_an_API_on_IdP_From_Client], 2);
    goto label_88;

  label_88:
    call {:si_unique_call 87} $result.login_php$303.26$9$call_an_API_on_IdP_From_Client := login_php(Mem_T.User[$user$9$266.6$call_an_API_on_IdP_From_Client], $location$10$267.20$call_an_API_on_IdP_From_Client, $cookie$5$262.5$call_an_API_on_IdP_From_Client, 0);
    goto label_91;

  label_91:
    $returnValue$6$263.5$call_an_API_on_IdP_From_Client := $result.login_php$303.26$9$call_an_API_on_IdP_From_Client;
    goto label_92;
  ...
  label_93_true:
    assume INT_NEQ(Mem_T.INT4[$cookie$5$262.5$call_an_API_on_IdP_From_Client], 0 - 1);
    goto label_94;
  ...
  label_94:
    Mem_T.cookie_WWAHost_State := Mem_T.cookie_WWAHost_State[cookie_WWAHost_State(wwahost_state) := Mem_T.INT4[$cookie$5$262.5$call_an_API_on_IdP_From_Client]];
    goto label_1;

  label_95:
    $redirect_domain$11$268.17$call_an_API_on_IdP_From_Client := $result.poirot_nondet$273.34$1$call_an_API_on_IdP_From_Client;
    goto label_96;

  label_96:
    call {:si_unique_call 88} $result.poirot_nondet$274.24$2$call_an_API_on_IdP_From_Client := poirot_nondet();
    goto label_99;

  label_99:
    $scope$12$269.7$call_an_API_on_IdP_From_Client := $result.poirot_nondet$274.24$2$call_an_API_on_IdP_From_Client;
    goto label_100;
  ...
  label_101:
    call {:si_unique_call 89} $result.poirot_nondet$276.23$3$call_an_API_on_IdP_From_Client := poirot_nondet();
    goto label_104;

  label_104:
    Mem_T.User := Mem_T.User[$user$9$266.6$call_an_API_on_IdP_From_Client := $result.poirot_nondet$276.23$3$call_an_API_on_IdP_From_Client];
    goto label_105;
  ...
  label_106:
    call {:si_unique_call 90} $result.poirot_nondet$278.32$4$call_an_API_on_IdP_From_Client := poirot_nondet();
    goto label_109;

  label_109:
    $response_type$13$270.15$call_an_API_on_IdP_From_Client := $result.poirot_nondet$278.32$4$call_an_API_on_IdP_From_Client;
    goto label_110;

  label_110:
    assume INT_EQ($response_type$13$270.15$call_an_API_on_IdP_From_Client, 0) || INT_EQ($response_type$13$270.15$call_an_API_on_IdP_From_Client, 1);
    goto label_111;

  label_111:
    call {:si_unique_call 91} $result.poirot_nondet$280.25$5$call_an_API_on_IdP_From_Client := poirot_nondet();
    goto label_114;

  label_114:
    $app_ID$8$265.8$call_an_API_on_IdP_From_Client := $result.poirot_nondet$280.25$5$call_an_API_on_IdP_From_Client;
    goto label_115;
  ...
  label_116:
    call {:si_unique_call 92} $result.draw_from_knowledge_pool$282.54$7$call_an_API_on_IdP_From_Client := draw_from_knowledge_pool(2);
    goto label_119;

  label_119:
    call {:si_unique_call 93} $result.dialog_oauth$282.29$6$call_an_API_on_IdP_From_Client := dialog_oauth($result.draw_from_knowledge_pool$282.54$7$call_an_API_on_IdP_From_Client, $app_ID$8$265.8$call_an_API_on_IdP_From_Client, $redirect_domain$11$268.17$call_an_API_on_IdP_From_Client, $scope$12$269.7$call_an_API_on_IdP_From_Client, Mem_T.User[$user$9$266.6$call_an_API_on_IdP_From_Client], $response_type$13$270.15$call_an_API_on_IdP_From_Client, $location$10$267.20$call_an_API_on_IdP_From_Client, $access_token$2$259.5$call_an_API_on_IdP_From_Client, $code$4$261.5$call_an_API_on_IdP_From_Client);
    goto label_122;

  label_122:
    $returnValue$6$263.5$call_an_API_on_IdP_From_Client := $result.dialog_oauth$282.29$6$call_an_API_on_IdP_From_Client;
    goto label_123;
  ...
  label_130:
    call {:si_unique_call 94} add_knowledge_to_bob($k$7$264.11$call_an_API_on_IdP_From_Client);
    goto label_127;
  ...
  label_135:
    call {:si_unique_call 95} add_knowledge_to_bob($k$7$264.11$call_an_API_on_IdP_From_Client);
    goto label_1;

  label_138:
    $redirect_domain$11$268.17$call_an_API_on_IdP_From_Client := $result.poirot_nondet$341.34$19$call_an_API_on_IdP_From_Client;
    goto label_139;

  label_139:
    call {:si_unique_call 96} $result.poirot_nondet$342.25$20$call_an_API_on_IdP_From_Client := poirot_nondet();
    goto label_142;

  label_142:
    $app_ID$8$265.8$call_an_API_on_IdP_From_Client := $result.poirot_nondet$342.25$20$call_an_API_on_IdP_From_Client;
    goto label_143;
  ...
  label_144:
    call {:si_unique_call 97} $result.draw_from_knowledge_pool$344.149$22$call_an_API_on_IdP_From_Client := draw_from_knowledge_pool(3);
    goto label_147;

  label_147:
    call {:si_unique_call 98} $result.draw_from_knowledge_pool$344.108$23$call_an_API_on_IdP_From_Client := draw_from_knowledge_pool(6);
    goto label_150;

  label_150:
    call {:si_unique_call 99} $result.graph_facebook_com_oauth_access_token_bob$344.58$21$call_an_API_on_IdP_From_Client := graph_facebook_com_oauth_access_token_bob($redirect_domain$11$268.17$call_an_API_on_IdP_From_Client, $app_ID$8$265.8$call_an_API_on_IdP_From_Client, $result.draw_from_knowledge_pool$344.108$23$call_an_API_on_IdP_From_Client, $result.draw_from_knowledge_pool$344.149$22$call_an_API_on_IdP_From_Client, $access_token$2$259.5$call_an_API_on_IdP_From_Client);
    goto label_153;

  label_153:
    $returnValue$6$263.5$call_an_API_on_IdP_From_Client := $result.graph_facebook_com_oauth_access_token_bob$344.58$21$call_an_API_on_IdP_From_Client;
    goto label_1;
}



procedure call_an_API_on_client_SDK($API_id$1$231.35$call_an_API_on_client_SDK_.1: int);
  modifies alloc, Mem_T.INT4, Mem_T.Location_Knowledge, Mem_T.cookie_WWAHost_State, temp, Mem_T.access_token_App_Client_State, Mem_T.code_App_Client_State, Mem_T.type_Knowledge, Mem_T.value_Knowledge, Mem_T.token_value_Access_Token, Mem_T.code_value_Code, Mem_T.user_ID_Code, Mem_T.app_secret_Code, Mem_T.app_ID_Code, Mem_T.code_length_FB_Server_State, Mem_T.user_ID_Access_Token, Mem_T.scope_Access_Token, Mem_T.token_length_FB_Server_State, Mem_T.app_ID_Registered_App, Mem_T.app_secret_Registered_App, Mem_T.redirect_domain_Registered_App, Mem_T.scope_Registered_App, Mem_T.scope_length_Registered_App, Mem_T.cookie_value_Cookie, Mem_T.user_ID_Cookie, Mem_T.cookie_length_FB_Server_State, Mem_T.Scope, knowledge_length;



implementation call_an_API_on_client_SDK($API_id$1$231.35$call_an_API_on_client_SDK_.1: int)
{
  var havoc_stringTemp: int;
  var condVal: int;
  var $API_id$1$231.35$call_an_API_on_client_SDK: int;
  var $redirect_domain$2$232.17$call_an_API_on_client_SDK: int;
  var $result.poirot_nondet$236.33$1$call_an_API_on_client_SDK: int;
  var $result.poirot_nondet$238.23$2$call_an_API_on_client_SDK: int;
  var $scope$3$233.7$call_an_API_on_client_SDK: int;
  var tempBoogie0: int;
  var tempBoogie1: int;
  var tempBoogie2: int;
  var tempBoogie3: int;
  ...
  start:
    $API_id$1$231.35$call_an_API_on_client_SDK := $API_id$1$231.35$call_an_API_on_client_SDK_.1;
    goto label_3;
  ...
  label_6:
    call {:si_unique_call 100} $result.poirot_nondet$236.33$1$call_an_API_on_client_SDK := poirot_nondet();
    goto label_9;

  label_9:
    $redirect_domain$2$232.17$call_an_API_on_client_SDK := $result.poirot_nondet$236.33$1$call_an_API_on_client_SDK;
    goto label_10;

  label_10:
    assume INT_EQ($redirect_domain$2$232.17$call_an_API_on_client_SDK, 1) || INT_EQ($scope$3$233.7$call_an_API_on_client_SDK, 2);
    goto label_11;

  label_11:
    call {:si_unique_call 101} $result.poirot_nondet$238.23$2$call_an_API_on_client_SDK := poirot_nondet();
    goto label_14;

  label_14:
    $scope$3$233.7$call_an_API_on_client_SDK := $result.poirot_nondet$238.23$2$call_an_API_on_client_SDK;
    goto label_15;

  label_15:
    assume INT_EQ($scope$3$233.7$call_an_API_on_client_SDK, 1) || INT_EQ($scope$3$233.7$call_an_API_on_client_SDK, 2);
    goto label_16;

  label_16:
    call {:si_unique_call 102} Windows_Security_Authentication_Web_WebAuthenticationBroker_authenticateAsync($redirect_domain$2$232.17$call_an_API_on_client_SDK, $scope$3$233.7$call_an_API_on_client_SDK, 1);
    goto label_1;
}



procedure call_an_API_on_foo_service_app_From_Bob($API_id$1$219.49$call_an_API_on_foo_service_app_From_Bob_.1: int);
  modifies alloc, Mem_T.session_ID_RP_Session, Mem_T.user_ID_RP_Session, Mem_T.User, Mem_T.session_length_RP_State;



implementation call_an_API_on_foo_service_app_From_Bob($API_id$1$219.49$call_an_API_on_foo_service_app_From_Bob_.1: int)
{
  var havoc_stringTemp: int;
  var condVal: int;
  var $API_id$1$219.49$call_an_API_on_foo_service_app_From_Bob: int;
  var $access_token$3$221.5$call_an_API_on_foo_service_app_From_Bob: int;
  var $printf.arg.1$4$: int;
  var $result.draw_from_knowledge_pool$221.44$1$call_an_API_on_foo_service_app_From_Bob: int;
  var $result.foo_service_API_authenticate$222.39$2$call_an_API_on_foo_service_app_From_Bob: int;
  var $result.printf$225.8$3$call_an_API_on_foo_service_app_From_Bob: int;
  var $testRPS$2$220.15$call_an_API_on_foo_service_app_From_Bob: int;
  var tempBoogie0: int;
  var tempBoogie1: int;
  var tempBoogie2: int;
  var tempBoogie3: int;
  ...
  start:
    call {:si_unique_call 103} $result.foo_service_API_authenticate$222.39$2$call_an_API_on_foo_service_app_From_Bob := __HAVOC_malloc(8);
    call {:si_unique_call 104} $testRPS$2$220.15$call_an_API_on_foo_service_app_From_Bob := __HAVOC_malloc(8);
    $API_id$1$219.49$call_an_API_on_foo_service_app_From_Bob := $API_id$1$219.49$call_an_API_on_foo_service_app_From_Bob_.1;
    goto label_3;

  label_1:
    call {:si_unique_call 105} __HAVOC_free($result.foo_service_API_authenticate$222.39$2$call_an_API_on_foo_service_app_From_Bob);
    call {:si_unique_call 106} __HAVOC_free($testRPS$2$220.15$call_an_API_on_foo_service_app_From_Bob);
    return;
  ...
  label_5:
    call {:si_unique_call 107} $result.draw_from_knowledge_pool$221.44$1$call_an_API_on_foo_service_app_From_Bob := draw_from_knowledge_pool(1);
    goto label_8;

  label_8:
    $access_token$3$221.5$call_an_API_on_foo_service_app_From_Bob := $result.draw_from_knowledge_pool$221.44$1$call_an_API_on_foo_service_app_From_Bob;
    goto label_9;

  label_9:
    call {:si_unique_call 108} $result.foo_service_API_authenticate$222.39$2$call_an_API_on_foo_service_app_From_Bob := foo_service_API_authenticate($access_token$3$221.5$call_an_API_on_foo_service_app_From_Bob);
    goto label_12;

  label_12:
    Mem_T.session_ID_RP_Session := Mem_T.session_ID_RP_Session[session_ID_RP_Session($testRPS$2$220.15$call_an_API_on_foo_service_app_From_Bob) := Mem_T.session_ID_RP_Session[session_ID_RP_Session($result.foo_service_API_authenticate$222.39$2$call_an_API_on_foo_service_app_From_Bob)]];
    Mem_T.user_ID_RP_Session := Mem_T.user_ID_RP_Session[user_ID_RP_Session($testRPS$2$220.15$call_an_API_on_foo_service_app_From_Bob) := Mem_T.user_ID_RP_Session[user_ID_RP_Session($result.foo_service_API_authenticate$222.39$2$call_an_API_on_foo_service_app_From_Bob)]];
    goto label_13;
  ...
  label_13_true:
    assume INT_EQ(Mem_T.user_ID_RP_Session[user_ID_RP_Session($testRPS$2$220.15$call_an_API_on_foo_service_app_From_Bob)], 1);
    goto label_14;
  ...
  label_14:
    call {:si_unique_call 109} havoc_stringTemp := __HAVOC_malloc(1);
    $printf.arg.1$4$ := havoc_stringTemp;
    goto label_15;

  label_15:
    havoc $result.printf$225.8$3$call_an_API_on_foo_service_app_From_Bob;
    goto label_1;
}



procedure call_an_API_on_foo_service_app_From_Client($API_id$1$245.52$call_an_API_on_foo_service_app_From_Client_.1: int);
  modifies alloc, Mem_T.session_ID_RP_Session, Mem_T.user_ID_RP_Session, Mem_T.User, Mem_T.session_length_RP_State;



implementation call_an_API_on_foo_service_app_From_Client($API_id$1$245.52$call_an_API_on_foo_service_app_From_Client_.1: int)
{
  var havoc_stringTemp: int;
  var condVal: int;
  var $API_id$1$245.52$call_an_API_on_foo_service_app_From_Client: int;
  var $printf.arg.1$3$: int;
  var $result.foo_service_API_authenticate$247.39$1$call_an_API_on_foo_service_app_From_Client: int;
  var $result.printf$250.8$2$call_an_API_on_foo_service_app_From_Client: int;
  var $testRPS$2$246.15$call_an_API_on_foo_service_app_From_Client: int;
  var tempBoogie0: int;
  var tempBoogie1: int;
  var tempBoogie2: int;
  var tempBoogie3: int;
  ...
  start:
    call {:si_unique_call 110} $result.foo_service_API_authenticate$247.39$1$call_an_API_on_foo_service_app_From_Client := __HAVOC_malloc(8);
    call {:si_unique_call 111} $testRPS$2$246.15$call_an_API_on_foo_service_app_From_Client := __HAVOC_malloc(8);
    $API_id$1$245.52$call_an_API_on_foo_service_app_From_Client := $API_id$1$245.52$call_an_API_on_foo_service_app_From_Client_.1;
    goto label_3;

  label_1:
    call {:si_unique_call 112} __HAVOC_free($result.foo_service_API_authenticate$247.39$1$call_an_API_on_foo_service_app_From_Client);
    call {:si_unique_call 113} __HAVOC_free($testRPS$2$246.15$call_an_API_on_foo_service_app_From_Client);
    return;
  ...
  label_4:
    call {:si_unique_call 114} $result.foo_service_API_authenticate$247.39$1$call_an_API_on_foo_service_app_From_Client := foo_service_API_authenticate(Mem_T.access_token_App_Client_State[access_token_App_Client_State(Mem_T.current_state_WWAHost_State[current_state_WWAHost_State(wwahost_state)])]);
    goto label_7;

  label_7:
    Mem_T.session_ID_RP_Session := Mem_T.session_ID_RP_Session[session_ID_RP_Session($testRPS$2$246.15$call_an_API_on_foo_service_app_From_Client) := Mem_T.session_ID_RP_Session[session_ID_RP_Session($result.foo_service_API_authenticate$247.39$1$call_an_API_on_foo_service_app_From_Client)]];
    Mem_T.user_ID_RP_Session := Mem_T.user_ID_RP_Session[user_ID_RP_Session($testRPS$2$246.15$call_an_API_on_foo_service_app_From_Client) := Mem_T.user_ID_RP_Session[user_ID_RP_Session($result.foo_service_API_authenticate$247.39$1$call_an_API_on_foo_service_app_From_Client)]];
    goto label_8;
  ...
  label_8_true:
    assume INT_EQ(Mem_T.user_ID_RP_Session[user_ID_RP_Session($testRPS$2$246.15$call_an_API_on_foo_service_app_From_Client)], 2);
    goto label_9;
  ...
  label_11:
    havoc $result.printf$250.8$2$call_an_API_on_foo_service_app_From_Client;
    goto label_1;
}
...
implementation dialog_oauth($cookie$1$18.21$dialog_oauth_.1: int, $client_id$2$18.36$dialog_oauth_.1: int, $redirect_domain$3$18.63$dialog_oauth_.1: int, $scope$4$18.86$dialog_oauth_.1: int, $login_user$5$18.98$dialog_oauth_.1: int, $response_type$6$18.124$dialog_oauth_.1: int, $location$7$18.159$dialog_oauth_.1: int, $access_token$8$18.174$dialog_oauth_.1: int, $code$9$18.193$dialog_oauth_.1: int) returns ($result.dialog_oauth$18.4$1$dialog_oauth: int)
{
  ...
  start:
    call {:si_unique_call 116} $app$16$28.16$dialog_oauth := __HAVOC_malloc(20);
    call {:si_unique_call 117} $at$11$23.14$dialog_oauth := __HAVOC_malloc(12);
    call {:si_unique_call 118} $c$12$24.6$dialog_oauth := __HAVOC_malloc(16);
  ...
  label_1:
    call {:si_unique_call 120} __HAVOC_free($app$16$28.16$dialog_oauth);
    call {:si_unique_call 121} __HAVOC_free($at$11$23.14$dialog_oauth);
    call {:si_unique_call 122} __HAVOC_free($c$12$24.6$dialog_oauth);
...
implementation dialog_permissions_request($client_id$1$165.38$dialog_permissions_request_.1: int, $cookie$2$165.53$dialog_permissions_request_.1: int, $scope$3$165.67$dialog_permissions_request_.1: int, $response_type$4$165.88$dialog_permissions_request_.1: int, $location$5$165.123$dialog_permissions_request_.1: int, $access_token$6$165.138$dialog_permissions_request_.1: int, $code$7$165.157$dialog_permissions_request_.1: int) returns ($result.dialog_permissions_request$165.4$1$dialog_permissions_request: int)
{
  ...
  start:
    call {:si_unique_call 124} $app$8$167.16$dialog_permissions_request := __HAVOC_malloc(20);
    call {:si_unique_call 125} $at$9$168.14$dialog_permissions_request := __HAVOC_malloc(12);
    call {:si_unique_call 126} $c$10$169.6$dialog_permissions_request := __HAVOC_malloc(16);
    call {:si_unique_call 127} $result.question.2$ := __HAVOC_malloc(20);
  ...
  label_1:
    call {:si_unique_call 128} __HAVOC_free($app$8$167.16$dialog_permissions_request);
    call {:si_unique_call 129} __HAVOC_free($at$9$168.14$dialog_permissions_request);
    call {:si_unique_call 130} __HAVOC_free($c$10$169.6$dialog_permissions_request);
    call {:si_unique_call 131} __HAVOC_free($result.question.2$);
    return;
...
implementation draw_from_knowledge_pool($kt$1$6.44$draw_from_knowledge_pool_.1: int) returns ($result.draw_from_knowledge_pool$6.4$1$draw_from_knowledge_pool: int)
{
  var havoc_stringTemp: int;
  var condVal: int;
  ...
  label_4:
    call {:si_unique_call 132} $result.poirot_nondet$8.26$2$draw_from_knowledge_pool := poirot_nondet();
    goto label_7;
  ...
  label_11:
    $result.draw_from_knowledge_pool$6.4$1$draw_from_knowledge_pool := 0 - 1;
    goto label_1;
}
...
procedure foo_client_app_calls();
  modifies alloc, Mem_T.session_ID_RP_Session, Mem_T.user_ID_RP_Session, Mem_T.INT4, Mem_T.Location_Knowledge, Mem_T.cookie_WWAHost_State, temp, Mem_T.access_token_App_Client_State, Mem_T.code_App_Client_State, Mem_T.type_Knowledge, Mem_T.value_Knowledge, Mem_T.User, Mem_T.session_length_RP_State, Mem_T.token_value_Access_Token, Mem_T.code_value_Code, Mem_T.user_ID_Code, Mem_T.app_secret_Code, Mem_T.app_ID_Code, Mem_T.code_length_FB_Server_State, Mem_T.user_ID_Access_Token, Mem_T.scope_Access_Token, Mem_T.token_length_FB_Server_State, Mem_T.app_ID_Registered_App, Mem_T.app_secret_Registered_App, Mem_T.redirect_domain_Registered_App, Mem_T.scope_Registered_App, Mem_T.scope_length_Registered_App, Mem_T.cookie_value_Cookie, Mem_T.user_ID_Cookie, Mem_T.cookie_length_FB_Server_State, Mem_T.Scope, knowledge_length;
...
implementation foo_client_app_calls()
{
  ...
  label_5:
    call {:si_unique_call 133} $result.poirot_nondet$352.24$1$foo_client_app_calls := poirot_nondet();
    goto label_8;
  ...
  label_9:
    call {:si_unique_call 134} $result.poirot_nondet$353.21$2$foo_client_app_calls := poirot_nondet();
    goto label_12;
  ...
  label_13:
    call {:si_unique_call 135} $result.not_violating_client_dev_guide$354.35$3$foo_client_app_calls := not_violating_client_dev_guide(0, $callee_id$1$351.5$foo_client_app_calls, $API_id$2$351.16$foo_client_app_calls);
    goto label_16;
  ...
  label_17:
    call {:si_unique_call 136} $result.not_violating_common_sense$354.93$4$foo_client_app_calls := not_violating_common_sense(0, $callee_id$1$351.5$foo_client_app_calls, $API_id$2$351.16$foo_client_app_calls);
    goto label_20;
  ...
  label_21:
    call {:si_unique_call 137} update_dev_guide_status(0, $callee_id$1$351.5$foo_client_app_calls, $API_id$2$351.16$foo_client_app_calls);
    goto label_24;
  ...
  label_25:
    call {:si_unique_call 138} call_an_API_on_foo_service_app_From_Client($API_id$2$351.16$foo_client_app_calls);
    goto label_1;

  label_28:
    call {:si_unique_call 139} call_an_API_on_client_SDK($API_id$2$351.16$foo_client_app_calls);
    goto label_1;
}



procedure foo_service_API_authenticate($access_token$1$126.44$foo_service_API_authenticate_.1: int) returns ($result.foo_service_API_authenticate$126.11$1$foo_service_API_authenticate: int);
  modifies alloc, Mem_T.User, Mem_T.session_ID_RP_Session, Mem_T.user_ID_RP_Session, Mem_T.session_length_RP_State;



implementation foo_service_API_authenticate($access_token$1$126.44$foo_service_API_authenticate_.1: int) returns ($result.foo_service_API_authenticate$126.11$1$foo_service_API_authenticate: int)
{
  var havoc_stringTemp: int;
  var condVal: int;
  var $access_token$1$126.44$foo_service_API_authenticate: int;
  var $result.authenticate_user$135.25$2$foo_service_API_authenticate: int;
  var tempBoogie0: int;
  var tempBoogie1: int;
  var tempBoogie2: int;
  var tempBoogie3: int;
  ...
  start:
    call {:si_unique_call 140} $result.authenticate_user$135.25$2$foo_service_API_authenticate := __HAVOC_malloc(8);
    $access_token$1$126.44$foo_service_API_authenticate := $access_token$1$126.44$foo_service_API_authenticate_.1;
    goto label_3;

  label_1:
    call {:si_unique_call 141} __HAVOC_free($result.authenticate_user$135.25$2$foo_service_API_authenticate);
    return;
  ...
  label_3:
    call {:si_unique_call 142} $result.authenticate_user$135.25$2$foo_service_API_authenticate := authenticate_user($access_token$1$126.44$foo_service_API_authenticate);
    goto label_6;

  label_6:
    $result.foo_service_API_authenticate$126.11$1$foo_service_API_authenticate := $result.authenticate_user$135.25$2$foo_service_API_authenticate;
    goto label_1;
}
...
procedure graph_facebook_com_email_bob($access_token$1$53.37$graph_facebook_com_email_bob_.1: int, $user_email$2$53.63$graph_facebook_com_email_bob_.1: int) returns ($result.graph_facebook_com_email_bob$53.4$1$graph_facebook_com_email_bob: int);
  modifies alloc, Mem_T.User_Email, Mem_T.type_Knowledge, Mem_T.value_Knowledge, knowledge_length;



implementation graph_facebook_com_email_bob($access_token$1$53.37$graph_facebook_com_email_bob_.1: int, $user_email$2$53.63$graph_facebook_com_email_bob_.1: int) returns ($result.graph_facebook_com_email_bob$53.4$1$graph_facebook_com_email_bob: int)
{
  var havoc_stringTemp: int;
  var condVal: int;
  ...
  start:
    call {:si_unique_call 143} $k$3$55.11$graph_facebook_com_email_bob := __HAVOC_malloc(8);
  ...
  label_1:
    call {:si_unique_call 144} __HAVOC_free($k$3$55.11$graph_facebook_com_email_bob);
    return;
  ...
  label_5:
    call {:si_unique_call 145} $result.graph_facebook_com_email$57.41$2$graph_facebook_com_email_bob := graph_facebook_com_email($access_token$1$53.37$graph_facebook_com_email_bob, $user_email$2$53.63$graph_facebook_com_email_bob);
    goto label_8;
  ...
  label_13:
    call {:si_unique_call 146} add_knowledge_to_bob($k$3$55.11$graph_facebook_com_email_bob);
    goto label_10;
}
...
procedure graph_facebook_com_me_bob($access_token$1$39.34$graph_facebook_com_me_bob_.1: int, $user_ID$2$39.54$graph_facebook_com_me_bob_.1: int) returns ($result.graph_facebook_com_me_bob$39.4$1$graph_facebook_com_me_bob: int);
  modifies alloc, Mem_T.User, Mem_T.type_Knowledge, Mem_T.value_Knowledge, knowledge_length;



implementation graph_facebook_com_me_bob($access_token$1$39.34$graph_facebook_com_me_bob_.1: int, $user_ID$2$39.54$graph_facebook_com_me_bob_.1: int) returns ($result.graph_facebook_com_me_bob$39.4$1$graph_facebook_com_me_bob: int)
{
  var havoc_stringTemp: int;
  var condVal: int;
  ...
  start:
    call {:si_unique_call 147} $k$3$41.11$graph_facebook_com_me_bob := __HAVOC_malloc(8);
  ...
  label_1:
    call {:si_unique_call 148} __HAVOC_free($k$3$41.11$graph_facebook_com_me_bob);
    return;
  ...
  label_5:
    call {:si_unique_call 149} $result.graph_facebook_com_me$43.38$2$graph_facebook_com_me_bob := graph_facebook_com_me($access_token$1$39.34$graph_facebook_com_me_bob, $user_ID$2$39.54$graph_facebook_com_me_bob);
    goto label_8;
  ...
  label_13:
    call {:si_unique_call 150} add_knowledge_to_bob($k$3$41.11$graph_facebook_com_me_bob);
    goto label_10;
}
...
implementation graph_facebook_com_oauth_access_token($redirect_domain$1$295.58$graph_facebook_com_oauth_access_token_.1: int, $client_id$2$295.82$graph_facebook_com_oauth_access_token_.1: int, $app_secret$3$295.104$graph_facebook_com_oauth_access_token_.1: int, $code$4$295.120$graph_facebook_com_oauth_access_token_.1: int, $access_token$5$295.131$graph_facebook_com_oauth_access_token_.1: int) returns ($result.graph_facebook_com_oauth_access_token$295.4$1$graph_facebook_com_oauth_access_token: int)
{
  ...
  start:
    call {:si_unique_call 151} $app$10$303.16$graph_facebook_com_oauth_access_token := __HAVOC_malloc(20);
    call {:si_unique_call 152} $at$7$300.14$graph_facebook_com_oauth_access_token := __HAVOC_malloc(12);
    call {:si_unique_call 153} $result.question.2$ := __HAVOC_malloc(20);
  ...
  label_1:
    call {:si_unique_call 154} __HAVOC_free($app$10$303.16$graph_facebook_com_oauth_access_token);
    call {:si_unique_call 155} __HAVOC_free($at$7$300.14$graph_facebook_com_oauth_access_token);
    call {:si_unique_call 156} __HAVOC_free($result.question.2$);
    return;
...
procedure graph_facebook_com_oauth_access_token_bob($redirect_domain$1$26.62$graph_facebook_com_oauth_access_token_bob_.1: int, $client_id$2$26.86$graph_facebook_com_oauth_access_token_bob_.1: int, $app_secret$3$26.108$graph_facebook_com_oauth_access_token_bob_.1: int, $code$4$26.124$graph_facebook_com_oauth_access_token_bob_.1: int, $access_token$5$26.135$graph_facebook_com_oauth_access_token_bob_.1: int) returns ($result.graph_facebook_com_oauth_access_token_bob$26.4$1$graph_facebook_com_oauth_access_token_bob: int);
  modifies alloc, Mem_T.token_value_Access_Token, Mem_T.user_ID_Access_Token, Mem_T.scope_Access_Token, Mem_T.token_length_FB_Server_State, Mem_T.INT4, Mem_T.app_ID_Registered_App, Mem_T.app_secret_Registered_App, Mem_T.redirect_domain_Registered_App, Mem_T.scope_Registered_App, Mem_T.scope_length_Registered_App, Mem_T.type_Knowledge, Mem_T.value_Knowledge, knowledge_length;



implementation graph_facebook_com_oauth_access_token_bob($redirect_domain$1$26.62$graph_facebook_com_oauth_access_token_bob_.1: int, $client_id$2$26.86$graph_facebook_com_oauth_access_token_bob_.1: int, $app_secret$3$26.108$graph_facebook_com_oauth_access_token_bob_.1: int, $code$4$26.124$graph_facebook_com_oauth_access_token_bob_.1: int, $access_token$5$26.135$graph_facebook_com_oauth_access_token_bob_.1: int) returns ($result.graph_facebook_com_oauth_access_token_bob$26.4$1$graph_facebook_com_oauth_access_token_bob: int)
{
  var havoc_stringTemp: int;
  var condVal: int;
  ...
  start:
    call {:si_unique_call 157} $k$6$28.11$graph_facebook_com_oauth_access_token_bob := __HAVOC_malloc(8);
  ...
  label_1:
    call {:si_unique_call 158} __HAVOC_free($k$6$28.11$graph_facebook_com_oauth_access_token_bob);
    return;
  ...
  label_13:
    call {:si_unique_call 160} add_knowledge_to_bob($k$6$28.11$graph_facebook_com_oauth_access_token_bob);
    goto label_10;
}
...
procedure initiate_knowledge();
  modifies alloc, knowledge_length, Mem_T.type_Knowledge, Mem_T.value_Knowledge;
...
implementation initiate_knowledge()
{
  var havoc_stringTemp: int;
  var condVal: int;
  var $k1$1$429.11$initiate_knowledge: int;
  var $k2$2$429.14$initiate_knowledge: int;
  var tempBoogie0: int;
  var tempBoogie1: int;
  var tempBoogie2: int;
  var tempBoogie3: int;
  ...
  start:
    call {:si_unique_call 161} $k1$1$429.11$initiate_knowledge := __HAVOC_malloc(8);
    call {:si_unique_call 162} $k2$2$429.14$initiate_knowledge := __HAVOC_malloc(8);
    goto label_3;

  label_1:
    call {:si_unique_call 163} __HAVOC_free($k1$1$429.11$initiate_knowledge);
    call {:si_unique_call 164} __HAVOC_free($k2$2$429.14$initiate_knowledge);
    return;
  ...
  label_6:
    Mem_T.type_Knowledge := Mem_T.type_Knowledge[type_Knowledge($k1$1$429.11$initiate_knowledge) := 6];
    goto label_7;

  label_7:
    Mem_T.value_Knowledge := Mem_T.value_Knowledge[value_Knowledge($k1$1$429.11$initiate_knowledge) := 1];
    goto label_8;

  label_8:
    call {:si_unique_call 165} add_knowledge_to_bob($k1$1$429.11$initiate_knowledge);
    goto label_11;

  label_11:
    Mem_T.type_Knowledge := Mem_T.type_Knowledge[type_Knowledge($k2$2$429.14$initiate_knowledge) := 8];
    goto label_12;

  label_12:
    Mem_T.value_Knowledge := Mem_T.value_Knowledge[value_Knowledge($k2$2$429.14$initiate_knowledge) := 1];
    goto label_13;

  label_13:
    call {:si_unique_call 166} add_knowledge_to_bob($k2$2$429.14$initiate_knowledge);
    goto label_1;
}
...
implementation login_php($login_user$1$130.19$login_php_.1: int, $location$2$130.51$login_php_.1: int, $cookie$3$130.66$login_php_.1: int, $uc$4$130.91$login_php_.1: int) returns ($result.login_php$130.4$1$login_php: int)
{
  ...
  start:
    call {:si_unique_call 167} $c$5$132.8$login_php := __HAVOC_malloc(8);
  ...
  label_1:
    call {:si_unique_call 168} __HAVOC_free($c$5$132.8$login_php);
    return;
...
procedure main() returns ($result.main$443.4$1$main: int);
  modifies alloc, Mem_T.actionNumber_Dev_Guide_State, Mem_T.session_length_RP_State, Mem_T.rp_sessions_RP_State, Mem_T.cookies_FB_Server_State, Mem_T.cookie_length_FB_Server_State, Mem_T.tokens_FB_Server_State, Mem_T.token_length_FB_Server_State, Mem_T.codes_FB_Server_State, Mem_T.code_length_FB_Server_State, temp, Mem_T.app_ID_Registered_App, Mem_T.app_secret_Registered_App, Mem_T.redirect_domain_Registered_App, Mem_T.scope_Registered_App, Mem_T.Scope, Mem_T.scope_length_Registered_App, Mem_T.app_length_FB_Server_State, Mem_T.app_owner_App_Client_State, Mem_T.app_ID_App_Client_State, Mem_T.access_token_App_Client_State, Mem_T.code_App_Client_State, Mem_T.cookie_WWAHost_State, Mem_T.current_state_WWAHost_State, knowledge_length, Mem_T.type_Knowledge, Mem_T.value_Knowledge, devGuideState, foo_app_state, foo_rp_state, knowledge_base, mal_app_state, server_state, wwahost_state, Mem_T.session_ID_RP_Session, Mem_T.user_ID_RP_Session, Mem_T.INT4, Mem_T.Location_Knowledge, Mem_T.User, Mem_T.token_value_Access_Token, Mem_T.code_value_Code, Mem_T.user_ID_Code, Mem_T.app_secret_Code, Mem_T.app_ID_Code, Mem_T.user_ID_Access_Token, Mem_T.scope_Access_Token, Mem_T.cookie_value_Cookie, Mem_T.user_ID_Cookie, Mem_T.User_Email;



implementation main() returns ($result.main$443.4$1$main: int)
{
  var havoc_stringTemp: int;
  var condVal: int;
  var $BScope$7$454.7$main: int;
  var $FScope$6$453.7$main: int;
  var $ats$2$449.14$main: int;
  var $codes$5$452.6$main: int;
  var $cookies$4$451.8$main: int;
  var $result.draw_from_knowledge_pool$513.38$2$main: int;
  var $rps$3$450.12$main: int;
  var $user_email$1$448.12$main: int;
  var tempBoogie0: int;
  var tempBoogie1: int;
  var tempBoogie2: int;
  var tempBoogie3: int;
  ...
  start:
    ...
    call {:si_unique_call 169} __havoc_heapglobal_init();
    call {:si_unique_call 170} $BScope$7$454.7$main := __HAVOC_malloc(400);
    call {:si_unique_call 171} $FScope$6$453.7$main := __HAVOC_malloc(400);
    call {:si_unique_call 172} $ats$2$449.14$main := __HAVOC_malloc(1200);
    call {:si_unique_call 173} $codes$5$452.6$main := __HAVOC_malloc(1600);
    call {:si_unique_call 174} $cookies$4$451.8$main := __HAVOC_malloc(800);
    call {:si_unique_call 175} $rps$3$450.12$main := __HAVOC_malloc(800);
    goto label_3;

  label_1:
    call {:si_unique_call 176} __HAVOC_free($BScope$7$454.7$main);
    call {:si_unique_call 177} __HAVOC_free($FScope$6$453.7$main);
    call {:si_unique_call 178} __HAVOC_free($ats$2$449.14$main);
    call {:si_unique_call 179} __HAVOC_free($codes$5$452.6$main);
    call {:si_unique_call 180} __HAVOC_free($cookies$4$451.8$main);
    call {:si_unique_call 181} __HAVOC_free($rps$3$450.12$main);
    return;
  ...
  label_13:
    Mem_T.rp_sessions_RP_State := Mem_T.rp_sessions_RP_State[rp_sessions_RP_State(foo_rp_state) := $rps$3$450.12$main];
    goto label_14;

  label_14:
    Mem_T.cookies_FB_Server_State := Mem_T.cookies_FB_Server_State[cookies_FB_Server_State(server_state) := $cookies$4$451.8$main];
    goto label_15;
  ...
  label_16:
    Mem_T.tokens_FB_Server_State := Mem_T.tokens_FB_Server_State[tokens_FB_Server_State(server_state) := $ats$2$449.14$main];
    goto label_17;
  ...
  label_18:
    Mem_T.codes_FB_Server_State := Mem_T.codes_FB_Server_State[codes_FB_Server_State(server_state) := $codes$5$452.6$main];
    goto label_19;
  ...
  label_27:
    Mem_T.scope_Registered_App := Mem_T.scope_Registered_App[scope_Registered_App(app_F_FB_Server_State(server_state)) := $FScope$6$453.7$main];
    goto label_28;
  ...
  label_30:
    Mem_T.scope_Registered_App := Mem_T.scope_Registered_App[scope_Registered_App(app_B_FB_Server_State(server_state)) := $BScope$7$454.7$main];
    goto label_31;
  ...
  label_45:
    call {:si_unique_call 182} initiate_knowledge();
    goto label_48;

  label_48:
    call {:si_unique_call 183} takeAction();
    goto label_51;

  label_51:
    call {:si_unique_call 184} takeAction();
    goto label_54;

  label_54:
    call {:si_unique_call 185} $result.draw_from_knowledge_pool$513.38$2$main := draw_from_knowledge_pool(9);
    goto label_57;

  label_57:
    $user_email$1$448.12$main := $result.draw_from_knowledge_pool$513.38$2$main;
    goto label_58;

  label_58:
    assert INT_NEQ($user_email$1$448.12$main, 1);
    goto label_59;

  label_59:
    $result.main$443.4$1$main := 0;
    goto label_1;
}
...
procedure mal_client_app_calls();
  modifies alloc, Mem_T.session_ID_RP_Session, Mem_T.user_ID_RP_Session, Mem_T.INT4, Mem_T.Location_Knowledge, Mem_T.cookie_WWAHost_State, temp, Mem_T.access_token_App_Client_State, Mem_T.code_App_Client_State, Mem_T.type_Knowledge, Mem_T.value_Knowledge, Mem_T.User, knowledge_length, Mem_T.session_length_RP_State, Mem_T.token_value_Access_Token, Mem_T.code_value_Code, Mem_T.user_ID_Code, Mem_T.app_secret_Code, Mem_T.app_ID_Code, Mem_T.code_length_FB_Server_State, Mem_T.user_ID_Access_Token, Mem_T.scope_Access_Token, Mem_T.token_length_FB_Server_State, Mem_T.app_ID_Registered_App, Mem_T.app_secret_Registered_App, Mem_T.redirect_domain_Registered_App, Mem_T.scope_Registered_App, Mem_T.scope_length_Registered_App, Mem_T.cookie_value_Cookie, Mem_T.user_ID_Cookie, Mem_T.cookie_length_FB_Server_State, Mem_T.Scope, Mem_T.User_Email;
...
implementation mal_client_app_calls()
{
  ...
  var $result.not_violating_client_dev_guide$372.35$3$mal_client_app_calls: int;
  var $result.not_violating_common_sense$372.93$4$mal_client_app_calls: int;
  var $result.poirot_nondet$369.24$1$mal_client_app_calls: int;
  var $result.poirot_nondet$371.21$2$mal_client_app_calls: int;
  var tempBoogie0: int;
  var tempBoogie1: int;
  var tempBoogie2: int;
  var tempBoogie3: int;
  ...
  label_5:
    call {:si_unique_call 186} $result.poirot_nondet$369.24$1$mal_client_app_calls := poirot_nondet();
    goto label_8;
  ...
  label_9:
    call {:si_unique_call 187} $result.poirot_nondet$371.21$2$mal_client_app_calls := poirot_nondet();
    goto label_12;

  label_12:
    $API_id$2$368.16$mal_client_app_calls := $result.poirot_nondet$371.21$2$mal_client_app_calls;
    goto label_13;

  label_13:
    call {:si_unique_call 188} $result.not_violating_client_dev_guide$372.35$3$mal_client_app_calls := not_violating_client_dev_guide(1, $callee_id$1$368.5$mal_client_app_calls, $API_id$2$368.16$mal_client_app_calls);
    goto label_16;
  ...
  label_16_true:
    assume $result.not_violating_client_dev_guide$372.35$3$mal_client_app_calls != 0;
    goto label_17;
  ...
  label_17:
    call {:si_unique_call 189} $result.not_violating_common_sense$372.93$4$mal_client_app_calls := not_violating_common_sense(1, $callee_id$1$368.5$mal_client_app_calls, $API_id$2$368.16$mal_client_app_calls);
    goto label_20;
  ...
  label_20_true:
    assume $result.not_violating_common_sense$372.93$4$mal_client_app_calls != 0;
    goto label_21;
  ...
  label_21:
    call {:si_unique_call 190} update_dev_guide_status(1, $callee_id$1$368.5$mal_client_app_calls, $API_id$2$368.16$mal_client_app_calls);
    goto label_24;
  ...
  label_25:
    call {:si_unique_call 191} call_an_API_on_foo_service_app_From_Client($API_id$2$368.16$mal_client_app_calls);
    goto label_1;

  label_28:
    call {:si_unique_call 192} call_an_API_on_client_SDK($API_id$2$368.16$mal_client_app_calls);
    goto label_1;

  label_31:
    call {:si_unique_call 193} call_an_API_on_IdP_From_Client($API_id$2$368.16$mal_client_app_calls);
    goto label_1;
}



procedure not_violating_client_dev_guide($caller$1$116.42$not_violating_client_dev_guide_.1: int, $callee_id$2$116.54$not_violating_client_dev_guide_.1: int, $API_id$3$116.68$not_violating_client_dev_guide_.1: int) returns ($result.not_violating_client_dev_guide$116.4$1$not_violating_client_dev_guide: int);



implementation not_violating_client_dev_guide($caller$1$116.42$not_violating_client_dev_guide_.1: int, $callee_id$2$116.54$not_violating_client_dev_guide_.1: int, $API_id$3$116.68$not_violating_client_dev_guide_.1: int) returns ($result.not_violating_client_dev_guide$116.4$1$not_violating_client_dev_guide: int)
{
  var havoc_stringTemp: int;
  var condVal: int;
  var $API_id$3$116.68$not_violating_client_dev_guide: int;
  var $callee_id$2$116.54$not_violating_client_dev_guide: int;
  var $caller$1$116.42$not_violating_client_dev_guide: int;
  var tempBoogie0: int;
  var tempBoogie1: int;
  var tempBoogie2: int;
  var tempBoogie3: int;
  ...
  start:
    $caller$1$116.42$not_violating_client_dev_guide := $caller$1$116.42$not_violating_client_dev_guide_.1;
    $callee_id$2$116.54$not_violating_client_dev_guide := $callee_id$2$116.54$not_violating_client_dev_guide_.1;
    $API_id$3$116.68$not_violating_client_dev_guide := $API_id$3$116.68$not_violating_client_dev_guide_.1;
    goto label_3;
  ...
  label_3:
    $result.not_violating_client_dev_guide$116.4$1$not_violating_client_dev_guide := 1;
    goto label_1;
}
...
implementation not_violating_common_sense($caller$1$58.38$not_violating_common_sense_.1: int, $callee_id$2$58.50$not_violating_common_sense_.1: int, $API_id$3$58.64$not_violating_common_sense_.1: int) returns ($result.not_violating_common_sense$58.4$1$not_violating_common_sense: int)
{
  var havoc_stringTemp: int;
  var condVal: int;
...
procedure takeAction();
  modifies Mem_T.current_state_WWAHost_State, Mem_T.app_ID_App_Client_State, alloc, Mem_T.session_ID_RP_Session, Mem_T.user_ID_RP_Session, Mem_T.INT4, Mem_T.Location_Knowledge, Mem_T.cookie_WWAHost_State, temp, Mem_T.access_token_App_Client_State, Mem_T.code_App_Client_State, Mem_T.type_Knowledge, Mem_T.value_Knowledge, Mem_T.User, knowledge_length, Mem_T.actionNumber_Dev_Guide_State, Mem_T.session_length_RP_State, Mem_T.token_value_Access_Token, Mem_T.code_value_Code, Mem_T.user_ID_Code, Mem_T.app_secret_Code, Mem_T.app_ID_Code, Mem_T.code_length_FB_Server_State, Mem_T.user_ID_Access_Token, Mem_T.scope_Access_Token, Mem_T.token_length_FB_Server_State, Mem_T.app_ID_Registered_App, Mem_T.app_secret_Registered_App, Mem_T.redirect_domain_Registered_App, Mem_T.scope_Registered_App, Mem_T.scope_length_Registered_App, Mem_T.cookie_value_Cookie, Mem_T.user_ID_Cookie, Mem_T.cookie_length_FB_Server_State, Mem_T.Scope, Mem_T.User_Email;
...
implementation takeAction()
{
  var havoc_stringTemp: int;
  var condVal: int;
  var $result.poirot_nondet$407.21$1$takeAction: int;
  ...
  label_3:
    call {:si_unique_call 194} $result.poirot_nondet$407.21$1$takeAction := poirot_nondet();
    goto label_6;
  ...
  label_6_case_0:
    assume INT_NEQ($result.poirot_nondet$407.21$1$takeAction, 0);
    assume INT_NEQ($result.poirot_nondet$407.21$1$takeAction, 1);
    goto label_7;

  label_6_case_1:
    assume INT_EQ($result.poirot_nondet$407.21$1$takeAction, 0);
    goto label_10;

  label_6_case_2:
    assume INT_EQ($result.poirot_nondet$407.21$1$takeAction, 1);
    goto label_11;

  label_7:
    call {:si_unique_call 195} Bob_calls();
    goto label_20;
  ...
  label_11:
    call {:si_unique_call 196} $result.poirot_nondet$413.38$2$takeAction := poirot_nondet();
    goto label_14;
  ...
  label_17:
    call {:si_unique_call 197} mal_client_app_calls();
    goto label_20;
  ...
  label_21:
    call {:si_unique_call 198} foo_client_app_calls();
    goto label_20;
}



procedure update_dev_guide_status($caller$1$120.36$update_dev_guide_status_.1: int, $callee_id$2$120.48$update_dev_guide_status_.1: int, $API_id$3$120.62$update_dev_guide_status_.1: int);



implementation update_dev_guide_status($caller$1$120.36$update_dev_guide_status_.1: int, $callee_id$2$120.48$update_dev_guide_status_.1: int, $API_id$3$120.62$update_dev_guide_status_.1: int)
{
  var havoc_stringTemp: int;
  var condVal: int;
  var $API_id$3$120.62$update_dev_guide_status: int;
  var $callee_id$2$120.48$update_dev_guide_status: int;
  var $caller$1$120.36$update_dev_guide_status: int;
  var tempBoogie0: int;
  var tempBoogie1: int;
  var tempBoogie2: int;
  var tempBoogie3: int;
  ...
  start:
    $caller$1$120.36$update_dev_guide_status := $caller$1$120.36$update_dev_guide_status_.1;
    $callee_id$2$120.48$update_dev_guide_status := $callee_id$2$120.48$update_dev_guide_status_.1;
    $API_id$3$120.62$update_dev_guide_status := $API_id$3$120.62$update_dev_guide_status_.1;
    goto label_1;
...
procedure {:inline 1} __havoc_heapglobal_init();
  modifies devGuideState, alloc, foo_app_state, foo_rp_state, knowledge_base, mal_app_state, server_state, wwahost_state;
...
implementation {:inline 1} __havoc_heapglobal_init()
{
  ...
  anon0:
    call {:si_unique_call 199} devGuideState := __HAVOC_malloc(4);
    call {:si_unique_call 200} foo_app_state := __HAVOC_malloc(16);
    call {:si_unique_call 201} foo_rp_state := __HAVOC_malloc(8);
    call {:si_unique_call 202} knowledge_base := __HAVOC_malloc(0);
    call {:si_unique_call 203} mal_app_state := __HAVOC_malloc(16);
    call {:si_unique_call 204} server_state := __HAVOC_malloc(68);
    call {:si_unique_call 205} wwahost_state := __HAVOC_malloc(8);
    return;
}
